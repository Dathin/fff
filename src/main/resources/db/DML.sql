...
CREATE INDEX FEATURE_FLAGS_ENVIRONMENT_ID ON FEATURE_FLAGS (ENVIRONMENT_ID);
CREATE INDEX FEATURE_FLAGS_NAME ON FEATURE_FLAGS (NAME);
CREATE UNIQUE INDEX FEATURE_FLAGS_ACCOUNT_ID ON FEATURE_FLAGS (NAME, ENVIRONMENT_ID);
