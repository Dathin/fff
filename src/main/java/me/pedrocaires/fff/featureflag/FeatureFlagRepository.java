...
public class FeatureFlagRepository {
	...
	public FeatureFlagRepository(JdbcTemplate jdbcTemplate, FeatureFlagResultSetExtractor featureFlagResultSetExtractor) {
	...
	public FeatureFlag createFeatureFlag(CreateFeatureFlagRequest createFeatureFlagRequest) {
		return jdbcTemplate.query(
				...
				featureFlagResultSetExtractor.extractObject(), createFeatureFlagRequest.getName(), createFeatureFlagRequest.getEnvironmentId(),
